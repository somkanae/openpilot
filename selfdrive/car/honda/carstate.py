...
def get_can_messages(CP, gearbox_msg):
  ...
  if CP.carFingerprint in (CAR.ACCORD, CAR.ACCORDH, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_HYBRID, CAR.INSIGHT,
                           CAR.ACURA_RDX_3G, CAR.HONDA_E, CAR.CIVIC_2022, CAR.HRV_3G, CAR.HRV_EHEV):
    pass
...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    if CP.carFingerprint == CAR.HRV_EHEV:
      self.gearbox_msg = "GEARBOX_ALT"
    elif CP.carFingerprint == CAR.ACCORD and CP.transmissionType == TransmissionType.cvt:
